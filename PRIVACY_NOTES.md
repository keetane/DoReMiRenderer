...
DoReMi Palette is currently designed as an on-device practice app.

- No account is required.
- No ads are included.
- No third-party analytics SDK is included.
- No tracking is implemented.
- No server upload is performed by the app.
- Imported MusicXML / MXL files are parsed on device.
