...
struct PaletteScoreLoaderTests {
    ...
    @Test func settingsKeysStoreAndRestoreValues() throws {
        ...
        defaults.set(true, forKey: PaletteSettingsKeys.keyboardLineNumberVisible)
        defaults.set(false, forKey: PaletteSettingsKeys.topToolbarVisible)
        ...
        #expect(defaults.bool(forKey: PaletteSettingsKeys.keyboardLineNumberVisible) == true)
        #expect(defaults.bool(forKey: PaletteSettingsKeys.topToolbarVisible) == false)
